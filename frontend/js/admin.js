 ...
 * Handles user management and settings (SMTP, Twilio).
 */
    ...
    document.getElementById('btnAddUser').addEventListener('click', () => {
        const html = `
            ...
            <div class="form-group">
                ...
                <input type="email" id="newEmail" class="form-input" style="padding-left:14px;" placeholder="john@company.com">
            </div>
        `;
        ...
        showModal('Add New User', html, async (close) => {
            ...
            if (!body.user_id || !body.password || !body.full_name) {
